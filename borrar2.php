...
// si se ha indicado algún fichero y se ha pulsado a enviar, recoge cada elemento indicado para borrar del array y por cada valor, se introduce en la variable  $borrar
...
$borrar=str_replace("./","",$borrar);
    //Obtiene tamaño de archivo y lo pasa a KB, de esta forma diferenciamos carpetas de ficheros y ejecutar el comando que elimina carpetas o ficheros en función de esto
  ...
  $tamano=number_format(((ftp_size($conn,$borrar))/1024),2)." Kb";
     if($tamano!="-0.00 Kb") {
      ...
      if($tamano=="-0.00 Kb") {
               ...
               else {      echo "<tr class='fondotabla'><td align='center' ><font color='red'>El directorio <strong><font color='black'>".$borrar." </font></strong>  no se ha eliminado correctamente o no esta vac&iacute;o</font></td></tr>";
               }
...
else{ //Si no está marcado ningún fichero, se renvía al usuario la página principal de borrar indicándole un mensaje
