...
<head>
<title align="center">FTP-WEB</title><link rel="icon" type="image/ico" href="img/favicon.ico" />
</head>
<body  background="img/fondo.jpeg">
	...
	<table align="center" width="300" cellspacing="2" cellpadding="2" border="0">
		...
		<tr>
			<td align="right"> Nombre o Direccion del servidor FTP:</td>
			<td><input type="text" name="direccion" size="15" maxlength="50"></td>
		</tr>
